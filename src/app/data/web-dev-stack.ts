...
export const WEB_DEV_STACK: IStackInfo[] = [
  {
    ...
    header: 'Angular',
    text: 'In the war of the web-frameworks there is no right and wrong. Everything that will let you build a web-app is the right choice for you. For me it is Angular. It is like a big and stable toolbox that lets me get to productive results fairly quickly. Coming from React I really appreciate that you can rely on built-in functionality like Dependency Injection. You can easily have a simple state handling without the need of an external package. In addition the predefined folder/component structure lets me understand other Angular projects more easily.',
  },
  {
    imageUrl:
  ...
  },
  {
    ...
    header: 'MikroORM',
    text: 'ORM is very useful if your logic has to work with a database (like 100% of the time). You can easily store objects in your preferred DB without converting them first or writing any SQL-Statement. MikroORM provides a lot of functionality for your basic needs while maintaining better performance than most of its competitors.',
  },
  {
    imageUrl: 'https://www.postgresql.org/media/img/about/press/elephant.png',
    header: 'PostgreSQL',
    text: 'PostgreSQL is a modern, open source and efficient relational database. Enough said.',
  },
  {
    imageUrl:
  ...
  },
  {
    ...
    header: 'VSCode',
    text: 'Hands down the best text editor for web-development. Easy to use, free and very user friendly. Plus there are thousands of useful and actively maintained extensions to improve your workflow.',
  },
];
